...
const translations = {
    es: {
        ...
        'bu.unit4.title': 'Software y analítica predictiva',
        'bu.unit4.desc': 'Aplicaciones y plataformas de software para seguimiento, control, eficiencia productiva y anticipación de desvíos.',
        'bu.unit5.title': 'SICE Partners',
        'bu.unit5.desc': 'Plataformas de software ITS y soluciones para ciudades inteligentes, aplicadas a movilidad, iluminación, analítica y gestión urbana.',
    ...
    en: {
        ...
        'bu.unit4.title': 'Software and predictive analytics',
        'bu.unit4.desc': 'Software applications and platforms for monitoring, control, productive efficiency and early detection of deviations.',
        'bu.unit5.title': 'SICE Partners',
        'bu.unit5.desc': 'ITS software platforms and solutions for smart cities, applied to mobility, lighting, analytics and urban management.',
